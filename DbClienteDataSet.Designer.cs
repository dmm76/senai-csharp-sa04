...
namespace CRUD {
    ...
    public partial class DbClienteDataSet : global::System.Data.DataSet {
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClienteRow AddClienteRow(string nome, string celular, string email, string cidade) {
            ...
            private void InitClass() {
                ...
                this.columncidade.MaxLength = 180;
            }
...
namespace CRUD.DbClienteDataSetTableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Cliente] WHERE (([Id] = @Original_Id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_celular = 1 AND [celular] IS NULL) OR ([celular] = @Original_celular)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_cidade = 1 AND [cidade] IS NULL) OR ([cidade] = @Original_cidade)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cliente] ([nome], [celular], [email], [cidade]) VALUES (@nome," +
                " @celular, @email, @cidade);\r\nSELECT Id, nome, celular, email, cidade FROM Clien" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cliente] SET [nome] = @nome, [celular] = @celular, [email] = @email, [cidade] = @cidade WHERE (([Id] = @Original_Id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_celular = 1 AND [celular] IS NULL) OR ([celular] = @Original_celular)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_cidade = 1 AND [cidade] IS NULL) OR ([cidade] = @Original_cidade)));
SELECT Id, nome, celular, email, cidade FROM Cliente WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD.Properties.Settings.Default.DbClienteConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, nome, celular, email, cidade FROM dbo.Cliente";
        ...
        public virtual int Fill(DbClienteDataSet.ClienteDataTable dataTable) {
        ...
        public virtual DbClienteDataSet.ClienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DbClienteDataSet.ClienteDataTable dataTable = new DbClienteDataSet.ClienteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DbClienteDataSet.ClienteDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_nome, string Original_celular, string Original_email, string Original_cidade) {
        ...
        public virtual int Insert(string nome, string celular, string email, string cidade) {
            if ((nome == null)) {
        ...
        public virtual int Update(string nome, string celular, string email, string cidade, int Original_Id, string Original_nome, string Original_celular, string Original_email, string Original_cidade, int Id) {
            if ((nome == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, string celular, string email, string cidade, int Original_Id, string Original_nome, string Original_celular, string Original_email, string Original_cidade) {
            return this.Update(nome, celular, email, cidade, Original_Id, Original_nome, Original_celular, Original_email, Original_cidade, Original_Id);
        }
    }
